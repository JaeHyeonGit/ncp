...
POST_data = {
    "platformTypeCodeList.1" : "UBS64"
}

# api 호출
response = requests.get(api_server + api_url, headers=http_header, data=POST_data)
